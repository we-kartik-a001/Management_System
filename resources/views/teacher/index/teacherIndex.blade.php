...
@section('content')
    <body class="bg-white text-gray-800 min-h-screen py-10 px-3">
        ...
        <div class="max-w-5xl mx-auto flex flex-col gap-4 ">
            ...
            <a class="border-2 bg-green-600 font-semibold text-xl text-white border-blue-800 rounded-lg p-3 text-center w-1/5 hover:bg-green-800 "
                href="{{ route('teacher.create') }}">Add Teacher</a>
